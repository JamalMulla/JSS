...
void SCAMP5T::set_bitorder(Bitorder bitorder) {
...
void SCAMP5T::superpixel_positions_from_bitorder(position_map& locations) {
...
void SCAMP5T::superpixel_shift_patterns_from_bitorder(int bank, const std::shared_ptr<DREG>& RNORTH, const std::shared_ptr<DREG>& RSOUTH, const std::shared_ptr<DREG>& REAST, const std::shared_ptr<DREG>& RWEST, bool shift_left) {
...
void SCAMP5T::superpixel_shift_block(const std::shared_ptr<DREG>& dst, const std::shared_ptr<DREG>& src, const std::shared_ptr<DREG>& RNORTH, const std::shared_ptr<DREG>& RSOUTH, const std::shared_ptr<DREG>& REAST, const std::shared_ptr<DREG>& RWEST) {
...
void SCAMP5T::superpixel_adc(const std::shared_ptr<DREG>& dst, int bank, const std::shared_ptr<AREG>& src) {
...
void SCAMP5T::superpixel_dac(const std::shared_ptr<AREG>& dst, int bank, const std::shared_ptr<DREG>& src) {
    position_map locations;
    this->superpixel_positions_from_bitorder(locations);
...
void SCAMP5T::superpixel_in(const std::shared_ptr<DREG>& dst, int bank, int value) {
    position_map locations;
    this->superpixel_positions_from_bitorder(locations);
...
void SCAMP5T::superpixel_shift(const std::shared_ptr<DREG>& dst, int bank, const std::shared_ptr<DREG>& src, int shift_left) {
    int rows = src->read().rows;
    int cols = src->read().cols;
...
void SCAMP5T::superpixel_shift_right(const std::shared_ptr<DREG>& dst, int bank, const std::shared_ptr<DREG>& src) {
    // Logical shift right
    // src and dst cannot be the same
    superpixel_shift(dst, bank, src, false);
}
void SCAMP5T::superpixel_shift_left(const std::shared_ptr<DREG>& dst, int bank, const std::shared_ptr<DREG>& src) {
    // Logical shift left
    // src and dst cannot be the same
    superpixel_shift(dst, bank, src, true);
}

void SCAMP5T::superpixel_add(const std::shared_ptr<DREG>& dst, int bank, const std::shared_ptr<DREG>& src1, const std::shared_ptr<DREG>& src2) {
    // Clobbers R11
...
void SCAMP5T::superpixel_sub(const std::shared_ptr<DREG>& dst, int bank, const std::shared_ptr<DREG>& src1, const std::shared_ptr<DREG>& src2) {
    // Clobbers R11
...
void SCAMP5T::superpixel_movx(const std::shared_ptr<DREG>& dst, std::shared_ptr<DREG> src, news_t dir) {
...
void SCAMP5T::histogram(const std::shared_ptr<AREG>& src) {
...
void SCAMP5T::hog(const std::shared_ptr<AREG>& src) {
    // Clobbers A, B
...
rttr::variant SCAMP5T::bitorder_converter(json& j) {
    try {
...
RTTR_REGISTRATION {
    ...
    registration::class_<SCAMP5T>("SCAMP5T")
        ...
        .method("superpixel_positions_from_bitorder", &SCAMP5T::superpixel_positions_from_bitorder)
        .method("superpixel_shift_patterns_from_bitorder", &SCAMP5T::superpixel_shift_patterns_from_bitorder)
        .method("superpixel_adc", &SCAMP5T::superpixel_adc)
        .method("superpixel_dac", &SCAMP5T::superpixel_dac)
        .method("superpixel_in", &SCAMP5T::superpixel_in)
        .method("superpixel_shift", &SCAMP5T::superpixel_shift)
        .method("superpixel_shift_right", &SCAMP5T::superpixel_shift_right)
        .method("superpixel_shift_left", &SCAMP5T::superpixel_shift_left)
        .method("superpixel_add", &SCAMP5T::superpixel_add)
        .method("superpixel_sub", &SCAMP5T::superpixel_sub)
        .method("superpixel_movx", &SCAMP5T::superpixel_movx)
        .method("histogram", &SCAMP5T::histogram)
        .method("hog", &SCAMP5T::hog);
};
