...
void AnalogueBus::push_north(AnalogueRegister &a, AnalogueRegister& b, int offset, DigitalRegister &FLAG) {
...
void AnalogueBus::push_east(AnalogueRegister &a, AnalogueRegister &b, int offset, DigitalRegister &FLAG) {
...
void AnalogueBus::push_south(AnalogueRegister &a, AnalogueRegister &b, int offset, DigitalRegister &FLAG) {
...
void AnalogueBus::push_west(AnalogueRegister &a, AnalogueRegister &b, int offset, DigitalRegister &FLAG) {
